...
DHIVEHI_DOCS = {
    ...
    "ކްލާސް": "**ކްލާސް (class)**\n\nއައު ކްލާހެއް (Object-Oriented Class) އުފެއްދުމަށް ބޭނުންކުރާ ކީވޯޑު.\n\n```dhicode\nކްލާސް ދަރިވަރު\n    ވަޒީފާ ހަދާ_ވަޒީފާ(ނަން)\n        މި.ނަން = ނަން\n    ނިމުނީ\nނިމުނީ\n```",
    "މި": "**މި (this / self)**\n\nކްލާހެއްގެ އިންސްޓަންސް ނުވަތަ އަމިއްލަ ނަފްސަށް އިޝާރާތްކުރާ ކީވޯޑު.",
    "ދަރިކޮޅު": "**ދަރިކޮޅު (extends)**\n\nއެއް ކްލާހުން އަނެއް ކްލާހަށް ވާރުތަކުރުމަށް (Inheritance) ބޭނުންކުރާ ކީވޯޑު.",

    # Built-in functions & Phase 4 Backend
    ...
    "ސާވަރު": "**ސާވަރު(ޕޯޓް, ހޭންޑްލަރ, އޮޕްޝަން)**\n\nއައު އެޗްޓީޓީޕީ ސާވަރެއް (HTTP Web Server) ފެށުމަށް ބޭނުންކުރާ ފަންކްޝަން.",
    "ހުޅުވާ": "**ހުޅުވާ(މަގު)**\n\nއައު ޑޭޓާބޭސްއެއް (SQLite Database) ހުޅުވުމަށް ނުވަތަ ގުޅުމަށް ބޭނުންކުރާ ފަންކްޝަން.",
    "ރައުޓަރ_ހަދާ": "**ރައުޓަރ_ހަދާ()**\n\nއެޗްޓީޓީޕީ ސާވަރަށް އައު މައިކްރޯ ރައުޓަރެއް (Router) ހެދުން.",
    "ޖޭސަން_ޖަވާބު": "**ޖޭސަން_ޖަވާބު(ޑޭޓާ, ކޯޑު)**\n\nޖޭސަން އެޕީއައި (JSON API Response) ޖަވާބެއް ފޮނުވުމަށް އެހީތެރިވެދޭ ފަންކްޝަން."
}
